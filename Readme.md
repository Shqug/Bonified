...
Bone equipment can be recycled into bonemeal (unless this feature is disabled by the user) with the amount of bonemeal returned varyiong based on the remaining durability of the item.
